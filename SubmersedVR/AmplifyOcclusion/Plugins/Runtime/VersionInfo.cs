...
#pragma warning disable 429
    ...
    public class VersionInfo
    {
        ...
        public static int FullNumber => Major * 100 + Minor * 10 + Release;
        public int Number => m_major * 100 + m_minor * 10 + m_release;

        [SerializeField] private readonly int m_major;
        [SerializeField] private readonly int m_minor;
        [SerializeField] private readonly int m_release;
